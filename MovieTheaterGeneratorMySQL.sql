CREATE DATABASE  IF NOT EXISTS `movie_theater_chain` /*!40100 DEFAULT CHARACTER SET utf8 */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `movie_theater_chain`;
-- MySQL dump 10.13  Distrib 8.0.28, for Win64 (x86_64)
--
-- Host: localhost    Database: movie_theater_chain
-- ------------------------------------------------------
...
CREATE TABLE `employee` (
  ...
  `email` varchar(80) NOT NULL DEFAULT ((((left(`first_name`,1) + `last_name`) + cast(`employee_id` as char(9) charset utf8mb4)) + _utf8mb4'@miamitheaters.com')),
...
CREATE TABLE `sale_details` (
  ...
  KEY `fk_sale_details_item1_idx` (`item_id`),
  KEY `fk_sale_details_theater1_idx` (`theater_id`),
  ...
  CONSTRAINT `fk_sale_details_theater1` FOREIGN KEY (`theater_id`) REFERENCES `theater` (`theater_id`) ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `sales` (
  ...
  KEY `fk_sales_location1` (`location_id`),
  CONSTRAINT `fk_sales_employee1` FOREIGN KEY (`employee_id`) REFERENCES `employee` (`employee_id`) ON UPDATE CASCADE,
  CONSTRAINT `fk_sales_location1` FOREIGN KEY (`location_id`) REFERENCES `location` (`location_id`) ON UPDATE CASCADE
...
CREATE TABLE `theater` (
  ...
  KEY `fk_theater_location1_idx` (`location_id`) /*!80000 INVISIBLE */,
...
-- Dump completed on 2022-04-18 15:45:48
